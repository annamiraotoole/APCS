...
public class TallHarvester extends Robot
{
	public TallHarvester(int street, int avenue, Direction direction, int beepers)
    {
	...
	public static void main(String[] args) 
	{
        ...
        TallHarvester karel = new TallHarvester(2, 2, East, 0);
        World.setDelay(10);
